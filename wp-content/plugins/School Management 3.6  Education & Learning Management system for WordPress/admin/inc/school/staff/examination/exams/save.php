						...
						<div class="form-row">
							...
							<div class="form-group col-sm-6 col-md-3">
								<label for="wlsm_paper_code_<?php echo esc_attr( $index ); ?>" class="wlsm-font-bold">
									<?php esc_html_e( 'Paper Code', 'school-management' ); ?>:
								</label>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-12">
								<div class="wlsm-form-sub-heading wlsm-font-bold">
									<?php esc_html_e( 'Show in Results Assessment', 'school-management' ); ?>
								</div>
							</div>
						</div>
