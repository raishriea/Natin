...
class WLSM_Staff_General {
	public static function get_class_sections() {
		$current_user = WLSM_M_Role::can( array( 'manage_admissions', 'manage_students', 'manage_invoices', 'manage_transfer_student', 'manage_certificates', 'manage_library', 'manage_transport', 'manage_homework', 'manage_exams' ) );
	...
	public static function get_section_students() {
		$current_user = WLSM_M_Role::can( array( 'manage_invoices', 'manage_transfer_student', 'manage_certificates', 'manage_library' ) );
