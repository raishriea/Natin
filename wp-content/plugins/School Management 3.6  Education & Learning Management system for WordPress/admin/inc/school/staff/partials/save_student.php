			...
			<span class="wlsm-section-heading-box">
				<span class="wlsm-section-heading">
					...
					if ( $student ) {
						...
						printf( esc_html__( 'Edit Student: %1$s (Enrollment Number - %2$s)', 'school-management' ), esc_html( $name ), esc_html( $student->enrollment_number ) );
					} else {
			...
			<div class="wlsm-form-section">
				...
				<div class="form-row">
					<div class="form-group col-md-4">
						...
						<input type="text" name="admission_number" class="form-control" id="wlsm_admission_number" placeholder="<?php esc_attr_e( 'Enter admission number', 'school-management' ); ?>" value="<?php echo esc_attr( $admission_number ); ?>">
					</div>
