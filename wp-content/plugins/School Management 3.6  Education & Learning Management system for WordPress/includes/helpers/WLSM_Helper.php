...
class WLSM_Helper {
	...
	public static function get_certificate_place_holder( $key ) {
		if ( array_key_exists( $key, self::certificate_place_holders() ) ) {
			return self::certificate_place_holders()[ $key ];
		}
		return '';
	}

	public static function certificate_place_holders() {
		return array(
			'name'               => '[STUDENT_NAME]',
