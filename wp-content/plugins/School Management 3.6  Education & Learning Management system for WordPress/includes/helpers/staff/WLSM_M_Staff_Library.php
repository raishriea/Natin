...
class WLSM_M_Staff_Library {
	...
	public static function get_book_issued_status_text( $returned_at ) {
		if ( $returned_at ) {
			return '<span class="text-success wlsm-font-bold">' . esc_html__( 'Returned' ,'school-management' ) . '</span>';
		}

		return '<span class="text-primary wlsm-font-bold">' . esc_html__( 'Pending' ,'school-management' ) . '</span>';
	}
