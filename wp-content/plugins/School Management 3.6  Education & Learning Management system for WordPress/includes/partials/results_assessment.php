...
<tbody>
	...
	<tr>
		...
		<td><?php echo WLSM_Config::get_percentage_text( $total_maximum_marks, $total_obtained_marks ); ?></td>
	</tr>
	<?php
	}
	?>
	<tr>
		...
		<th><?php echo WLSM_Config::get_percentage_text( $overall_maximum_marks, $overall_obtained_marks ); ?></th>
	</tr>
</tbody>
