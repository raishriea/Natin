...
class WLSM_Shortcode {
	...
	public static function enqueue_assets() {
		...
		wp_enqueue_style( 'wlsm', WLSM_PLUGIN_URL . 'assets/css/wlsm.css', array(), '3.6', 'all' );
		wp_enqueue_style( 'wlsm-dashboard', WLSM_PLUGIN_URL . 'assets/css/wlsm-dashboard.css', array(), '3.6', 'all' );
		...
		wp_enqueue_script( 'wlsm-public', WLSM_PLUGIN_URL . 'assets/js/wlsm.js', array( 'jquery', 'jquery-form' ), '3.6', true );
