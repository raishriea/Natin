...
<div class="container">
	<div class="content-area">
		<main id="skip-content" class="site-main" role="main">
			<?php
		    $ultra_print_layout_option = get_theme_mod( 'ultra_print_theme_options',__( 'Right Sidebar','ultra-print' ) );
				    	...
				    	<section id="post_section">
							...
							while ( have_posts() ) : the_post();
								...
								the_post_navigation( array(
									'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'ultra-print' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'ultra-print' ) . '</span>',
									'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'ultra-print' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'ultra-print' ) . '</span> ',
								) );
