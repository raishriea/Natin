...
class Ultra_Print_Loader {
	 ...
	 * @return void
	 */
	public function ultra_print_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function ultra_print_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function ultra_print_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function ultra_print_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->ultra_print_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function ultra_print_load( $class ) {
